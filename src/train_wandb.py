...
def load_config_file(path: str):
    ...
    cfg_experiment = load_config(path)["experiment"]

    return cfg_model, cfg_data, cfg_hyperparam, cfg_experiment
...
if __name__ == "__main__":
    ...
    cfg_model, cfg_data, cfg_hyperparam, cfg_experiment = load_config_file("config/config.yaml")
    ...
    #config["loss_fn"] = loss_fn.__class__.__name__  # Just the name of the class
    ...
    config["model_name"] = build_model_name(cfg_model, cfg_hyperparam)
    
    
    
    # Initialize Weights and Biases

    with wandb.init(entity=cfg_experiment["entity"], project=cfg_experiment["project"], id=cfg_experiment["run_id"], resume=cfg_experiment["resume"], config=config) as run:
