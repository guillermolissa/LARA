...
if __name__ == "__main__":
    ...
    total_steps = epochs * len(train_dataloader) // num_accumulation_steps
    ...
    for epoch in tqdm(range(start_epoch, epochs), total=epochs, desc="Training...", colour="orange"):
        for batch_idx, (input_batch, target_batch) in enumerate(train_dataloader):
            ...
            do_step = (
                ...
                or (batch_idx + 1) % num_accumulation_steps == 0
            ...
            if (global_step % evaluation_frequency) == 0 and global_step > 0:
