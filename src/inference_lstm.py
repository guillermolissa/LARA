...
from lstm import LSTMModel   # Adjust the import based on the actual location of LSTMModel
...
def generate_simple_items(model, idx, max_new_items, context_size, use_adaptive_softmax=False):
    ...
    h0, c0 = None, None  # Initialize hidden and cell states for LSTM
    ...
    for _ in range(max_new_items):
        ...
        with torch.no_grad():
            if use_adaptive_softmax:
                ...
                logits, h0, c0 = model(idx_cond, h0, c0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-mnt', '--max_new_items', type=int, default=10, help='Number of new items to generate. Ej: 8')
